...
var randomImage = function(params) {
	...
	default: null //"/galleries/test1/img1.jpg"
	}, params);

	if (options.bucket !== null && options.path !== null && options.default !== null) {
		...
		console.log('please define parameters bucket, path and default like {bucket: "my.bucket.com", path: "random/images/", default: "/random/images/default.jpg"}');
	}
